...
import { RANKS_FORM_FIELDS} from '../constants/product_reviews-constants';
...
interface ProductReviewFormModalProps {
  open: boolean;
  editing: ProductReviewsResponse | null;
  submitting: boolean;
  onSubmit: (values: ProductReviewsRequest) => void;
  onClose: () => void;
}



export const ProductReviewFormModal: React.FC<ProductReviewFormModalProps> = ({
  open,
  editing,
  submitting,
  onSubmit,
  ...
  const [form] = Form.useForm<ProductReviewsRequest>();
