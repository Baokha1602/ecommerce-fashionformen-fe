...
import { RANKS_FORM_FIELDS} from '../constants/product_variants-constants';
...
interface ProductVariantFormModalProps {
  open: boolean;
  editing: ProductVariantResponse | null;
  submitting: boolean;
  onSubmit: (values: ProductVariantRequest) => void;
  onClose: () => void;
}



export const ProductVariantFormModal: React.FC<ProductVariantFormModalProps> = ({
  open,
  editing,
  submitting,
  onSubmit,
  ...
  const [form] = Form.useForm<ProductVariantRequest>();
