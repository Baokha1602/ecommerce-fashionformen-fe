...
import { RANKS_FORM_FIELDS} from '../constants/product_images-constants';
...
interface ProductImageFormModalProps {
  open: boolean;
  editing: ProductImagesResponse | null;
  submitting: boolean;
  onSubmit: (values: ProductImagesRequest) => void;
  onClose: () => void;
}



export const ProductImageFormModal: React.FC<ProductImageFormModalProps> = ({
  open,
  editing,
  submitting,
  onSubmit,
  ...
  const [form] = Form.useForm<ProductImagesRequest>();
